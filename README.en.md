...
| `GEMINI_IMAGE_TRACE_ENABLED` | Detailed Gemini image call trace logs for timing request receive, upstream forwarding, upstream response parsing, generated image storage, and downstream response | `false` |
